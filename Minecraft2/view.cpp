...
#define VTXSHADERPATH "vertex"
#define FRGSHADERPATH "fragment"
...
void View::create() {
	...
	window = glfwCreateWindow(getWidth(), getHeight(), "Minecraft2", NULL, NULL);
	if (!window) destroy();
	glfwMakeContextCurrent(window);

	glewExperimental = true; // Needed for core profile
	glewInit();
	//if (!glewInit == GLEW_OK) destroy();
